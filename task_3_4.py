...
def thesaurus(*args: str):
    ...
    for fullname in args:
        ...
        if not fullname_dict.get(surname[0]):
            fullname_dict[surname[0]] = {}

        if not fullname_dict[surname[0]].get(name[0]):
            fullname_dict[surname[0]][name[0]] = []

        fullname_dict[surname[0]][name[0]].append(fullname)
